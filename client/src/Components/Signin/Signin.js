...
class Signin extends Component {
	...
	render() {
		...
		const { isFetching, message, success } = this.props.SigninData;
		const {
			state: { emptymessage },
		} = this;
				...
				<div className="col-lg-8 container-custom  p-5">
					<div className="row shadow border-rad">
						<div className="col-md-6 p-0 container-image">
							<img className="img-fluid img-login d-block" src={loader} />
						...
						<div className="col-md-6 container-form">
							<div className="my-4">
								<img className="img-fluid img mx-auto d-block" src={loader} />
							</div>
